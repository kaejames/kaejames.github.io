...
Polling average of generic ballot and women voters for the 2022 midterms elections using __Echelon Insights, Fox News Poll, NYT/Siena, Cygnal,Selzer&Co and Monmouth University Poll__. Fresh new polls are avaeraged when possible.
...
```{r, echo=FALSE}
tablepolls<-read_excel(("~/Documents/RSTUDIO/kaejames.github.io/midterms22.xlsx"), sheet = "table") 
knitr::opts_chunk$set(error = TRUE)
```
