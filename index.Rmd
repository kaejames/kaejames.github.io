...
---
<br>
President Biden approval tracking from January 2021 after he became the president. Tracking all registered voters and voters under the age of 35. The polling firms used are **Fox News Polls, Monmouth University, Quinnipiac University,Echelon Insights, Marist Polls and NYT/Sienna**.
</br>
...
p<-ggplot(approval)+
  ...
  labs(x="", y="", title = "Approval Tracking",
...
p<-ggplot(under35)+
  geom_line(aes(x=Date, y=Results,colour=Key, group=Key), lwd=2) +
  labs(x="", y="", title = "Approval Tracking - Under 35",
       caption = "source;Echelon Insights, Fox News Poll & Monmouth University")+
  scale_color_manual(values =c("green","indianred2")) +
  theme(plot.title = element_text(color = "black", family = "Ubuntu",  size = 17, face="bold", hjust = 0),
        plot.caption = element_text(color = "black", size=13, face = "italic", family = "Ubuntu"),
