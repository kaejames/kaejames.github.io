...
---
<br>
President Biden approval tracking from January 2021 after he became the president. Tracking all registered/likely voters and Gen Z/Millennials. The polling firms used are **Fox News Polls, Monmouth University, Quinnipiac University,Echelon Insights, Marist College and NYT/Sienna**.
</br>
...
approval<- read_excel("Biden.xlsx", sheet = "BidenAVG", 
    col_types = c("date", "numeric", "text")) 
knitr::opts_chunk$set(warning  = FALSE) 
```
```{r, echo=FALSE, message=FALSE}
under35 <- read_excel("Biden.xlsx", sheet = "U35AVG", 
    col_types = c("date", "numeric", "text")) 
knitr::opts_chunk$set(warning = FALSE) 
```
```{r, echo=FALSE}
